        ...
        <div class="col-12 col-md-4 col-sm-12 col-xs-12">
            <div class="card p-4">
                ...
                <div class="d-flex flex-column temp mt-5 mb-3">
                    <h1 class="mb-0 font-weight-bold" id="heading"> 14° C </h1> <span class="small grey">Outside</span>
                    <h1 class="mb-0 font-weight-bold" id="heading"> 13° C </h1> <span class="small grey">Home</span>
                </div>
                <div class="d-flex">
